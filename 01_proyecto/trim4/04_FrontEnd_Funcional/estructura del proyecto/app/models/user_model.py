...
def insert_user(connection, numeroDocumento, nombreUsuario, primerApellido, segundoApellido, Direccion, telefono, contraseña, correoElectronico, estadoUsuario, idRol , idTipoDeDocumento):
    print("📤 Ejecutando SQL con datos:")
    datos = ( numeroDocumento, nombreUsuario, primerApellido, segundoApellido, Direccion, telefono, contraseña, correoElectronico, estadoUsuario, idRol , idTipoDeDocumento)
    print(datos)
    try:
        with connection.cursor() as cursor:
            sql = """
                INSERT INTO Usuario (
                    ...
                    segundoApellido, Direccion, telefono, contraseña, correoElectronico,
                    estadoUsuario, idRol, idTipoDeDocumento
...
def get_user_by_email(connection, correoElectronico):
    with connection.cursor() as cursor:
        cursor.execute("SELECT idUsuario, contraseña AS password, idRol, nombreUsuario  FROM Usuario WHERE correoElectronico =%s", (correoElectronico,))
