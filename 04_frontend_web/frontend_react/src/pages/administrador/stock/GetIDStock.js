...
export default function GetIDStock() {
  ...
  return (
    <div className="main-content">
      ...
      <div className="container-fluid" id="container-admin-stock-id">
        <div className="header">    
          ...
          <div className="row">
            <div className="col-9 d-flex align-items-end px-1 gap-2 w-50 isla-admin">
              <Link to={`/stock/${idProducto}`} className="btn custom-btn-admin btn-light">
                Registrar Stock
              </Link>
              <Link to="/ver_color" className="btn custom-btn-admin btn-light">
                Color
              </Link>
            </div>
          </div>
