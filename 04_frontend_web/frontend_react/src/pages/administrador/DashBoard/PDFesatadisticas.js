                ...
                {filtros && (
                    <View style={styles.filterInfo}>
                        ...
                        {filtros.estado && filtros.estado !== 'todos' && (
                            <Text>• Estado: {filtros.estado}</Text>
                        )}
                ...
                <View style={styles.twoColumns}>
                    <View style={styles.column}>
                        ...
                        <View style={styles.table}>
                            ...
                            {Object.entries(estadosStats).map(([estado, cantidad], index) => (
                                <View key={estado} style={[styles.tableRow, index % 2 === 0 && styles.tableRowEven]}>
                                    <Text style={[styles.tableCell, getEstadoBadge(estado)]}>{estado}</Text>
                    ...
                    <View style={styles.table}>
                        ...
                        {pedidos.slice(-5).reverse().map((pedido, index) => (
                            <View key={pedido.idPedido} style={[styles.tableRow, index % 2 === 0 && styles.tableRowEven]}>
                                ...
                                <Text style={[styles.tableCell, getEstadoBadge(pedido.estado)]}>{pedido.estado}</Text>
