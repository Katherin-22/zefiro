        ...
        return datos.reduce((acc, item) => {
            ...
            if (pedidoExistente) {
                ...
                acc.push({
                    ...
                    estado: item.estadestadoPedido || 'Pendiente',
                                                    ...
                                                    <tr className={styles.tablePrimary}>
                                                        ...
                                                        <td>
                                                            <select 
                                                                ...
                                                                style={{
                                                                    backgroundColor: 
                                                                        pedido.estadoPedido === 'Pendiente' ? '#fff3cd' :
                                                                        pedido.estadoPedido === 'Procesando' ? '#cfe2ff' :
                                                                        pedido.estadoPedido === 'Entregado' ? '#d1e7dd' : 'white'
                                                                }}
                                                            >
                                                                <option value="Pendiente">Pendiente</option>
                                                                <option value="Procesando">Procesando</option>
